class Teacher < ActiveRecord::Base
  ...
  after_create :add_default_classroom, :add_default_classroom2, :add_default_classroom3
  ...
  def add_default_classroom2
    self.classrooms.create(name: "Sample Classroom2")

    default_classroom = self.classrooms.find_by(name: "Sample Classroom2")
  ...
  def add_default_classroom3
    self.classrooms.create(name: "Sample Classroom3")

    default_classroom = self.classrooms.find_by(name: "Sample Classroom3")
