...
class TeacherTracksTest < Capybara::Rails::TestCase
  ...
  test "a teacher can unpublish a published track" do
    ...
    assert page.has_css?('.unpublished'), 'The unpublished track was not labelled'
  end
  ...
  test "a teacher can publish an unpublished track" do
    ...
    assert !page.has_css?('.unpublished'), 'The published track was labelled with Unpublished'
  end
